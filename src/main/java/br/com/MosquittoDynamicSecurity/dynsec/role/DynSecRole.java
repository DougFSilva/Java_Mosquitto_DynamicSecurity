...
/**
 * A classe <b>RoleCommand</b> possui métodos que retornam um JsonObject
...
public class DynSecRole {
	...
	public JsonObject createCommand() {
		...
		command.addProperty("rolename", rolename);
		return command;
	}
	 ...
	 * @return Retorna um JsonObject contendo o comando para adicionar uma ACL a uma
	 *         role
	 */
	 ...
	 * @return Retorna um JsonObject contendo o comando para adicionar uma ACL a uma
	 *         role com definição de prioridade<br/>
	 ...
	 * @return Retorna um JsonObject contendo o comando para remover uma ACL de uma
	 *         role
	 */
	...
	public String toString() {
		return "RoleCommand [rolename=" + rolename + "]";
	}
